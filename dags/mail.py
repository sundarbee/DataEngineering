...
dag = DAG("Check_for_new_entries_and_send_mail", description="This dag is to check if there were new entries made in the database, if so then send mail to users at the end of the day.",
          start_date=datetime(2020, 8, 11), catchup=False)

with dag:
    # task 1: check if there were new entries made today.
    def get_todays_entries_and_send_mail():
        # This list will hold all the entries that were made today.
        entries_made_today = []
        ...
        try:
            ...
            connection = psycopg2.connect(
                user="abhijeet", password="9zsU5DmuTZ6kyFR", host="localhost", port="5433", database="efw")
            ...
            # This list will contain all the column names.
            ...
            # Create a dataframe and save as .xlsx file.
                ...
                print('Excel sheet saved with ' +
                    str(len(entries_made_today)) + ' entries.')
        ...
        if(len(entries_made_today) > 0):
            ...
            receiver_email = "singh.yudi20@gmail.com"
            password = usr_pwd
